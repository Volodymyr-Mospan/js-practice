...
// console.log(createProduct({ name: '🍋', price: 20, quantity: 5 }, logTotalPrice));
...
//             onError(`Перевищено ліміт транзаккції ${TRANSACTION_LIMIT}`);
//         } else if (amount > this.balance) {
//             onError(`Перевищено залишок коштів ${this.balance}`);
//         } else {
//             this.balance -= amount;
//             onSuccess(`Операція зняття ${amount} успішна. Баланс становить ${this.balance}`);
//         }
//     },
...
//             onError(`Перевищено ліміт транзаккції ${TRANSACTION_LIMIT}`);
//         } else if (amount === 0) {
//             onError(`Нічого не внесено`);
//         } else {
//             this.balance += amount;
//             onSuccess(
//                 `Операція внесення коштів ${amount} успішна. Баланс становить ${this.balance}`
//             );
//         }
//     },
// };
