...
// const languigeName = prompt('Яка офіційна назва JavaScript?');

// if (languigeName === 'ECMAScript') {
//   alert('Правильно!');
// } else {
...
//   alert('Це нуль');
// } else if (userInput > 0) {
//   alert('Це додатне число');
// } else {
//   alert('Це відємне число');
// }

// Example 4 - Вкладені розгалуженн ------------------------------------------------------------------------

// Напиши скрипт, який порівнює числа у змінних a та b.
// Якщо обидва значення більш-е 100, то виведи в консоль максимальне з них.
